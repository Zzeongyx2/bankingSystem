...
public class BankTransaction {
    ...
    public BankTransaction (String transactionID, String payee, double amount) {
    ...
    public BankTransaction (String transactionID, String timestamp, String payee, double amount, long dbId) {
    ...
    public BankTransaction(String transactionID, String timestamp, double amount, long dbId) {
        this(transactionID, amount);
        this.timestamp = timestamp;
        this.dbId = dbId;
    }

    public BankTransaction(String transactionID, String sendingAccount, String destinationAccount, double amount) {
        this.transactionID = transactionID;
    ...
    public BankTransaction(String transactionID, String timestamp, String sendingAccount, String destinationAccount, double amount, long dbId) {
